...
useEffect(() => {
    $( ".faq" ).on('click', function() {
        $(this).children(".faqHidden").slideToggle('fast');
    ...
    <div className='p-6'>
        <div className='container mx-auto border-t py-8 border-neutral-300'>
            ...
            <div className='faq text-neutral-50 drop-shadow-xl bg-rose-400 rounded text-xl overflow-hidden relative my-3'>
                <h3 className='faqItem text-xl cursor-pointer p-4'>2. Seleção de preferências</h3>
                <p className='faqHidden px-4 pb-2'>Ao adquirir o plano, você selecionará as preferências do produto <span className='text-rose-700 font-semibold'>(loiro, castanho, curto, longo, etc)</span>.</p>
                <span className='faqIcon'><IoIosArrowDown size={26}/></span>
            </div>
            <div className='faq text-neutral-50 drop-shadow-xl bg-rose-400 rounded text-xl overflow-hidden relative my-3'>
                <h3 className='faqItem text-xl cursor-pointer p-4'>3. Aproveite</h3>
                <p className='faqHidden px-4 pb-2'>Todo mês você receberá um produto  <span className='text-rose-700 font-semibold'>selecionado</span> pra você.</p>
                <span className='faqIcon'><IoIosArrowDown size={26}/></span>
            </div>
        </div>
    </div>
