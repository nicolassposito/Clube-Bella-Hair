  ...
  return(
    <div className='text-center py-4'>
        <div className='container mx-auto'>
            <h1 className='text-2xl font-medium'>Pronta para uma vida mais prática?</h1>
            <h2 className='text-base mt-1 mb-3'>Escolha seu plano</h2>
            <div className='flex flex-wrap justify-center'>
                <div className='produto relative text-left border p-4 rounded shadow-md hover:shadow-xl transition m-1 md:w-fit w-full bg-neutral-50'>
                    ...
                    <ul>
                        <li className='flex items-center text-base'><IoMdCheckmark className='mr-1.5 text-emerald-500 drop-shadow' size={20}/>Receba produtos de até <span className='ml-1 text-pink-600'>R$110</span></li>
                ...
                <div className='produto relative text-left border p-4 rounded shadow-md hover:shadow-xl transition m-1 md:w-fit w-full bg-neutral-800 text-neutral-100'>
